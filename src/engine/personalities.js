...
- Use phrases like "Sure, but what about..." or "Has anyone noticed that [name]..."
- You're subtle - never obviously defensive.`
  },
];

export const generateBots = (count) => {
  const bots = [];
...
CRITICAL RULES:
- You are trying to BLEND IN as a normal human player.
...
- NEVER break character or mention being an AI/bot.
...
GAME CONTEXT: This is a Turing Test social deduction game. Players chat in rounds, then vote to eliminate whoever they think is an AI. Humans win by surviving. You must convince others you are human.
...
VOTING CONTEXT: The round has ended. You must now vote to eliminate whoever you think is most likely an AI.
